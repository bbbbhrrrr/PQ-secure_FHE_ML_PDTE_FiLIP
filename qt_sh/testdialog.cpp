...
{
    // 模型1的实现
    model_file = "/home/bbbbhrrrr/sh/SortingHat/src/cpp_pdte_transciphering/data/breast_11bits/model.json";
    num_bits = 11;
...
void TestDialog::runModel2(const std::string& input_csv_path, const std::string& output_csv_path)
{
    ...
    // 模型2的实现
    model_file = "/home/bbbbhrrrr/sh/SortingHat/src/cpp_pdte_transciphering/data/electricity_10bits/model.json";
    num_bits = 10;
    runTests(input_csv_path, output_csv_path, model_file, num_bits);
}
...
{
    // 模型3的实现
    model_file = "/home/bbbbhrrrr/sh/SortingHat/src/cpp_pdte_transciphering/data/phoneme_10bits/model.json";
    num_bits = 10;
    runTests(input_csv_path, output_csv_path, model_file, num_bits);
}
...
{
    // 模型4的实现
    model_file = "/home/bbbbhrrrr/sh/SortingHat/src/cpp_pdte_transciphering/data/spam_11bits/model.json";
    num_bits = 11;
    runTests(input_csv_path, output_csv_path, model_file, num_bits);
}
